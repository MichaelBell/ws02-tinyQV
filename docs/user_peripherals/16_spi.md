...
The IOs used are intended to be compatible with an SPI PMOD:
...
The SPI bus can be shared by multiple devices, by switching the desired CS to be controlled by the SPI controller, and all others to be set high by GPIO.
...
| 0x05    | MISO_SELECT | R/W | 0 (default) = in2, 1 = in6 |
